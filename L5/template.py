...
''' use tf.dataset as input rather than placeholder '''
''' 
    1. placeholder can be added with function add_placeholders()
        (1) change the input of inference() to placeholder
        (2) change how to feed data in train and placeholder
    2. If no need for simultaneous validation, train and test can be done in one function, without seperate one_epoch function
'''
